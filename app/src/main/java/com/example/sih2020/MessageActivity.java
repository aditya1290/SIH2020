...
import com.example.sih2020.adapter.MessageAdapter;
//import com.koddev.chatapp.Fragments.APIService;
import com.example.sih2020.Model.Chat;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               // if (user.getImageURL().equals("default")){
                ...
                readMessages(fuser.getUid(), userid, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnDR5gIN6NXWAePc8bEzdsHOUZnLJwcEWEq3z16LrKe0m0Hg3i&s");
            }
