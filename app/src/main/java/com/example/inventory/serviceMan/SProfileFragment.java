...
public class SProfileFragment extends Fragment {
    ...
    private void showImagePickerOptions() {
        ImagePickerActivity.showImagePickerOptions(getActivity().getApplicationContext(), new ImagePickerActivity.PickerOptionListener() {
            @Override
    ...
    private void showSettingsDialog() {
        ...
        builder.setPositiveButton(getString(R.string.go_to_settings), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                SProfileFragment.this.openSettings();
            }
        });
